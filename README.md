...
│   ├── agents/               #   LangGraph agent nodes (analytics, profiler, etc.)
│   ├── api/                  #   FastAPI backend (campaign CRUD, HITL endpoints)
│   ├── tools/                #   OpenAPI → StructuredTool runtime loader
...
# Edit backend/.env and add your GROQ_API_KEY and CAMPAIGNX_API_KEY
```
...
npx @stoplight/prism-cli mock backend/campaignx_api.json
